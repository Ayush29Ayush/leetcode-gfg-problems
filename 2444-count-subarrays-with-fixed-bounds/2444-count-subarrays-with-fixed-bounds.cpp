// https://leetcode.com/problems/count-subarrays-with-fixed-bounds/discuss/3254003/Day-63-oror-Two-Pointer-oror-O(n)-time-and-O(1)-space-oror-Easiest-Beginner-Friendly-sol
class Solution {
public:
